...
public class Test
{
	...
	public void statics() throws ClassNotFoundException, InterruptedException, IOException
	{
		Job staticsUser=Test.statisticsUser();
		Job staticsItem=Test.statistciItem(FileOutputFormat.getOutputPath(staticsUser));
		ControlledJob job_staticsUser=new ControlledJob(staticsUser.getConfiguration());
		ControlledJob job_staticsItem=new ControlledJob(staticsItem.getConfiguration());
